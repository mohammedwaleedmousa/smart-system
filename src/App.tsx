...
function HomePage() {
  return (
    <>
      ...
      <section className="dark-section"><div className="section dark-inner"><SectionTitle eyebrow="Capabilities" title="One team across design, engineering and intelligent automation." copy="You do not need separate teams for product design, frontend and AI. We keep the work connected from idea to implementation." /><div className="capabilities-grid">{services.map((service, index)=><article key={service.title}><span>0{index+1}</span><div className="capability-icon"><Icon name={service.icon}/></div><h3>{service.title}</h3><p>{service.copy}</p><a href="#/services">Learn more <Icon name="arrow" size={15}/></a></article>)}</div></div></section>
      <section className="section industry-section"><SectionTitle eyebrow="Industries" title="Flexible solutions for different business models." copy="The technology changes with the business context, while the same product discipline stays consistent." /><div className="industry-grid">{industries.map((industry)=><article key={industry.title}><div className="industry-icon"><Icon name={industry.icon}/></div><div><h3>{industry.title}</h3><p>{industry.copy}</p></div><Icon name="arrow" size={18}/></article>)}</div></section>
      <section className="work-section"><div className="section"><SectionTitle eyebrow="Selected work" title="A few products and systems we are building." copy="Our work spans commerce, business software and digital platforms." action={<a className="text-link" href="#/work">View case studies <Icon name="arrow" size={16}/></a>} /><WorkPreview /></div></section>
      <section className="section engage-section"><SectionTitle eyebrow="How we can help" title="Choose the engagement that matches your stage." /><div className="engage-grid"><article><span className="engage-number">01</span><div className="engage-icon"><Icon name="rocket"/></div><h3>Build something new</h3><p>Define, design and build a new digital product or platform from the ground up.</p><ul><li>Product definition</li><li>UI/UX system</li><li>Frontend build</li></ul></article><article><span className="engage-number">02</span><div className="engage-icon"><Icon name="layers"/></div><h3>Modernize a system</h3><p>Improve an existing experience that feels dated, fragmented or difficult to maintain.</p><ul><li>UX audit</li><li>Interface redesign</li><li>Frontend modernization</li></ul></article><article><span className="engage-number">03</span><div className="engage-icon"><Icon name="automation"/></div><h3>Automate operations</h3><p>Use AI and workflow automation to remove repetitive tasks and speed up team operations.</p><ul><li>Workflow analysis</li><li>AI integration</li><li>Automation design</li></ul></article></div></section>
      <section className="company-highlight"><div className="company-visual"><div className="company-grid-art"><span/><span/><span/><span/><span/><span/><span/><span/><span/></div><div className="company-badge"><Icon name="people"/><div><span>Focused team</span><strong>Direct ownership</strong></div></div></div><div className="company-copy"><span className="eyebrow">Why Smart System</span><h2>A technology partner, not just a website vendor.</h2><p>We care about the whole system: the business need, the user experience, the technical structure and what happens after launch.</p><div className="company-list"><div><Icon name="check"/><span>Direct communication with the people doing the work</span></div><div><Icon name="check"/><span>Design and engineering decisions made together</span></div><div><Icon name="check"/><span>Systems designed for maintainability and growth</span></div></div><a className="btn btn-dark" href="#/company">About Smart System <Icon name="arrow" size={16}/></a></div></section>
      <CTA />
    </>
  )
}
